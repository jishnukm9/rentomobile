...
<div className='mt-auto'>
         ...
         <p className='text-2xl font-bold text-globaltext'>{data.price}</p>
         
         </div>
         <button className='w-100p bg-green-600 hover:bg-green-700 px-3 py-2 text-white rounded-md'>View Deal</button>
         </div>
       </div>
