  ...
  return (
    <div className="max-w-[1200px] mx-auto py-10 px-10">
      <h2 className="text-2xl font-bold mb-10">
        Top Two-Wheeler Brands in Our Fleet
      </h2>
      <div className="mb-20">
        <LogoList />
      </div>
      ...
      <div className="grid grid-cols-1 gap-16 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 mb-10">
        <FeatureItemBig
          heading="Clean two wheelers. Flexible bookings. Socially distant rental counters."
          description="We’re working with our partners to keep you safe and in the driving seat"
          imgurl="https://cdn2.rcstatic.com/com.rentalcars.185492029745.eu-west-1.web.prod.static-live/images/landing-pages/covid-banner/desktop/thumbnail_covid@1x.png"
        />
        <FeatureItemBig
