...
export default function Info() {
  return (
    <div className='max-w-[1200px] mx-auto py-10 px-10'>
        ...
        <h2 className='text-2xl font-bold mb-10'>Connecting you to the biggest brands in two wheeler rental</h2>
